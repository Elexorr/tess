...
obj_label = tk.Label(master=frame1, text='Object ID:', bg='grey')
...
author_label = tk.Label(master=frame1, text='Author:', bg='grey')
...
exptime_label = tk.Label(master=frame1, text='Exptime:', bg='grey')
...
sector_label = tk.Label(master=frame1, text='#:', bg='grey')
